...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen w-full overflow-y-auto bg-gradient-to-br from-[#F9FAFB] via-[#FDFBF7] to-[#F3F4F6]">
      <div className="space-y-6 p-6 lg:p-8">
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              <p className="text-sm uppercase tracking-wide text-[#1B4D3E]/70 font-semibold">
                Profile
              </p>
              <h1 className="text-3xl font-bold text-gray-900 mt-1">Account Overview</h1>
            ...
            <div className="flex flex-wrap gap-3">
              <Button
                ...
                className="border-[#1B4D3E]/30 text-[#1B4D3E] hover:bg-[#1B4D3E]/10"
              >
              ...
              <CardContent className="pt-6 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                <div className="flex items-center gap-4">
                  <Avatar className="h-16 w-16 border border-gray-200">
                    ...
                    <AvatarFallback className="bg-[#1B4D3E] text-white text-xl font-semibold">
                      {profile.fullName?.charAt(0) ?? "U"}
                    </AvatarFallback>
                  </Avatar>
                  <div>
                    <p className="text-sm text-gray-500">Signed in as</p>
                    <p className="text-2xl font-semibold text-gray-900">{profile.fullName}</p>
                ...
                <div className="text-sm text-gray-500 space-y-1">
                  <p className="flex items-center gap-2">
                    ...
                    Primary role: <span className="font-semibold text-gray-900">{profile.primaryRole}</span>
                  </p>
                  <p className="flex items-center gap-2">
                    <CalendarDays className="w-4 h-4 text-[#1B4D3E]" />
                    Last sign-in: <span className="font-semibold text-gray-900">{formatDate(profile.lastSignInAt)}</span>
                  </p>
                </div>
              </CardContent>
            </Card>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-2">
                    ...
                    {canManageRoles ? (
                      ...
                      <div className="flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-700">
                        <ShieldQuestion className="w-4 h-4 text-[#1B4D3E]" />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-600 space-y-1">
                      <p className="flex items-center gap-2">
                        <UserCircle2 className="w-4 h-4 text-[#1B4D3E]" />
                        Created: <span className="font-medium text-gray-900">{formatDate(profile.createdAt)}</span>
                      </p>
                      <p className="flex items-center gap-2">
                        <CalendarDays className="w-4 h-4 text-[#1B4D3E]" />
                        Updated: <span className="font-medium text-gray-900">{formatDate(profile.updatedAt)}</span>
                      </p>
                    </div>
                  </div>
                </CardContent>
                ...
                <div className="space-y-4">
                  <div className="rounded-xl border border-gray-200 bg-white p-4">
                    <div className="flex items-center gap-3">
                      <ShieldCheck className="w-10 h-10 rounded-full bg-[#1B4D3E]/10 text-[#1B4D3E] p-2" />
                      <div>
                        <p className="text-sm text-gray-500">Last sign-in</p>
                        <p className="text-base font-semibold text-gray-900">{formatDate(profile.lastSignInAt)}</p>
                      </div>
                    </div>
                  ...
                  <div className="rounded-xl border border-gray-200 bg-white p-4">
                    <div className="flex items-center gap-3">
                      <Building2 className="w-10 h-10 rounded-full bg-[#1B4D3E]/10 text-[#1B4D3E] p-2" />
                      <div>
                        <p className="text-sm text-gray-500">Linked campus</p>
